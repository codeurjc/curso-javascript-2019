...
var getAccessToken = function (token) {
	...
	var tokens = config.tokens.filter(savedToken =>
...
var getClient = function (clientId, clientSecret) {
	...
	var confidentialClients = config.confidentialClients.filter(client =>
		client.clientId === clientId && client.clientSecret === clientSecret
	);
...
var getUser = function (username, password) {
	...
	var users = config.users.filter(user =>
...
var getUserFromClient = function (client) {
	...
	var clients = config.confidentialClients.filter(savedClient =>
...
var revokeToken = function (token) {
	...
	var revokedTokensFound = config.tokens.filter(savedToken =>
		savedToken.refreshToken === token.refreshToken
	);
